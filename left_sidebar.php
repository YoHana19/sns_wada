      ...
      <?php else: ?>
        ...
        <div id="<?php echo $content_id ?>" class="container pb-mw-content">
          <div class="row pb-name-box">
            <div class="pb-link-page"><?php echo $room['nick_name']; ?></div>
          </div>
          <div class="row">
            <img src="assets/images/users/<?php echo $room['user_picture_path']; ?>" style="width: 100%; height: 270px;">
          </div>
          <div class="row">
            <div class="col-md-6 pb-link-box" style="border-right: 1px solid #aaa;">
              <div class="pb-link-page">個人ページへ</div>
              <a href="user.php?user_id=<?php echo $room['member_id']; ?>"></a>
            </div>
            <div class="col-md-6 pb-link-box" style="border-left: 1px solid #aaa;">
              <div class="pb-link-page">チャットページへ</div>
              <a href="chat.php?friend_id=<?php echo $room['member_id']; ?>"></a>
            </div>
          </div>
