          ...
          $.ajax({
            ...
            if (page == 0) { // 最後の投稿ではない
              ...
              posts.forEach(function(post) {
                ...
                if (state == 'unlike') {
                  $('#posts')
                  .append('<div class="icons"><button type="button" id="' + haiku_id + '" class="like btn icon-btn btn-primary btn-color-like"><span id="' + haiku_id + '_icon" class="glyphicon btn-glyphicon glyphicon-thumbs-up img-circle text-color-like"></span>よし</button>')
                  ...
                  $('#posts')
                  .append('<button type="button" id="' + haiku_id + '" class="like btn icon-btn btn-primary btn-color-un"><span id="' + haiku_id + '_icon" class="glyphicon btn-glyphicon glyphicon-thumbs-up img-circle text-color-un"></span>よし</button>')
                  .on('click', '#' + haiku_id, function() { // よし機能
                ...
                // あし
                $('#posts')
                  .append('<a class="btn icon-btn btn-color-dislike" href="#"><span class="glyphicon btn-glyphicon glyphicon-thumbs-down img-circle text-color-dislike"></span>あし</a>');
