      ...
      <div class="col-md-8 right-content">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <!-- あし歌人1位 -->
            <?php if(isset($bad_members_info[0])): ?>
              <div class="ranking ranking-1">
            ...
            <!-- あし歌人2位 -->
            <?php if(isset($bad_members_info[1])): ?>
              <div class="ranking ranking-2">
            ...
            <!-- あし歌人3位 -->
            <?php if(isset($bad_members_info[2])): ?>
              <div class="ranking ranking-3">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <!-- 句あし1位 -->
            <?php if(isset($bad_haikus_info[0])): ?>
              <div class="ranking">
                <div class="ku-rank-wrap-1">
                  <!-- 句の内容 -->
                  <div class="ku-ranking ku-ranking-1">
