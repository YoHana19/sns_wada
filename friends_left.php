  ...
  <div class="left-wrap">
    <?php foreach ($friends_name as $friend_name) { ?>
      ...
      <button type="button" class="btn btn-custom call-mw">
        <div class="media" style="position: relative; margin-top: 7px">
          <a class="pull-left left-photo" href="#">
            <img class="media-object" src="assets/images/<?php echo $friend_info['user_picture_path']; ?>">
          </a>
      ...
      <div id="<?php echo $content_id ?>" class="pb-mw-content">
        <img src="assets/images/<?php echo $friend_info['user_picture_path']; ?>" style="width: 100px; height: 100px;">
